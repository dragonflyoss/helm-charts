...
| dfdaemon.tag | string | `"v2.1.10"` | Image tag. |
...
| manager.tag | string | `"v2.1.10"` | Image tag. |
...
| scheduler.tag | string | `"v2.1.10"` | Image tag. |
...
| seedPeer.tag | string | `"v2.1.10"` | Image tag. |
...
| trainer.tag | string | `"v2.1.10"` | Image tag. |
