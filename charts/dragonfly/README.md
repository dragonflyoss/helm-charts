...
| dfdaemon.tag | string | `"v2.0.9-rc.2"` | Image tag |
...
| manager.tag | string | `"v2.0.9-rc.2"` | Image tag |
...
| scheduler.tag | string | `"v2.0.9-rc.2"` | Image tag |
...
| seedPeer.tag | string | `"v2.0.9-rc.2"` | Image tag |
