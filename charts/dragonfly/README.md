...
| cdn.tag | string | `"v2.0.2-rc.12"` | Image tag |
...
| dfdaemon.tag | string | `"v2.0.2-rc.12"` | Image tag |
...
| manager.tag | string | `"v2.0.2-rc.12"` | Image tag |
...
| scheduler.tag | string | `"v2.0.2-rc.12"` | Image tag |
