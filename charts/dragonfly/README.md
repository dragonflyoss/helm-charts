...
![Version: 0.5.38](https://img.shields.io/badge/Version-0.5.38-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.5.38](https://img.shields.io/badge/AppVersion-0.5.38-informational?style=flat-square)
...
| cdn.tag | string | `"v2.0.2-rc.4"` | Image tag |
...
| containerRuntime.containerd.configPathDir | string | `/host/etc/containerd/` | Custom config path directory, default is /etc/containerd/ . |
...
| dfdaemon.tag | string | `"v2.0.2-rc.4"` | Image tag |
...
| manager.tag | string | `"v2.0.2-rc.4"` | Image tag |
...
| scheduler.tag | string | `"v2.0.2-rc.4"` | Image tag |
