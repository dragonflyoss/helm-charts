...
| cdn.tag | string | `"v2.0.2-rc.27"` | Image tag |
...
| dfdaemon.tag | string | `"v2.0.2-rc.27"` | Image tag |
...
| manager.tag | string | `"v2.0.2-rc.27"` | Image tag |
...
| scheduler.tag | string | `"v2.0.2-rc.27"` | Image tag |
