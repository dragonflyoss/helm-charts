...
| client.config.download.server.requestRateLimit | int | `50` | requestRateLimit is the rate limit of the download request in dfdaemon, default is 50 req/s.  This limit applies to the total number of gRPC requests per second, including: - Multiple requests within a single connection. - Single requests across different connections. |
| client.config.download.server.requestbufferSize | int | `500` | requestbufferSize is the buffer size of the download request channel in dfdaemon, default is 500.  This controls the capacity of the bounded channel used to queue incoming gRPC requests before they are processed. If the buffer is full, new requests will return a `RESOURCE_EXHAUSTED` error. |
...
| client.dfinit.image.tag | string | `"v1.2.7"` | Image tag. |
...
| client.image.tag | string | `"v1.2.7"` | Image tag. |
...
| client.metrics.service.clusterIP | string | `""` | Service clusterIP. |
...
| manager.config.server.grpc.requestRateLimit | int | `4000` | RequestRateLimit is the maximum number of requests per second for the gRPC server. It limits both the rate of unary gRPC requests and the rate of new stream gRPC connection, default is 4000 req/s. |
...
| manager.image.tag | string | `"v2.4.1"` | Image tag. |
...
| manager.metrics.service.clusterIP | string | `""` | Service clusterIP. |
...
| scheduler.config.server.requestRateLimit | int | `4000` | RequestRateLimit is the maximum number of requests per second for the gRPC server. It limits both the rate of unary gRPC requests and the rate of new stream gRPC connection, default is 4000 req/s. |
...
| scheduler.image.tag | string | `"v2.4.1"` | Image tag. |
...
| scheduler.metrics.service.clusterIP | string | `""` | Service clusterIP. |
...
| seedClient.config.download.server.requestRateLimit | int | `4000` | requestRateLimit is the rate limit of the download request in dfdaemon, default is 4000 req/s.  This limit applies to the total number of gRPC requests per second, including: - Multiple requests within a single connection. - Single requests across different connections. |
| seedClient.config.download.server.requestbufferSize | int | `1000` | requestbufferSize is the buffer size of the download request channel in dfdaemon, default is 1000.  This controls the capacity of the bounded channel used to queue incoming gRPC requests before they are processed. If the buffer is full, new requests will return a `RESOURCE_EXHAUSTED` error. |
...
| seedClient.image.tag | string | `"v1.2.7"` | Image tag. |
...
| seedClient.metrics.service.clusterIP | string | `""` | Service clusterIP. |
