...
| client.dfinit.image.tag | string | `"v0.2.41"` | Image tag. |
...
| client.image.tag | string | `"v0.2.41"` | Image tag. |
...
| manager.image.tag | string | `"v2.2.4-rc.2"` | Image tag. |
...
| scheduler.image.tag | string | `"v2.2.4-rc.2"` | Image tag. |
...
| seedClient.image.tag | string | `"v0.2.41"` | Image tag. |
