...
| client.dfinit.image.tag | string | `"v0.1.103"` | Image tag. |
...
| client.image.tag | string | `"v0.1.103"` | Image tag. |
...
| manager.image.tag | string | `"v2.1.55"` | Image tag. |
...
| scheduler.image.tag | string | `"v2.1.55"` | Image tag. |
...
| seedClient.image.tag | string | `"v0.1.103"` | Image tag. |
