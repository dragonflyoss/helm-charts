...
![Version: 0.5.39](https://img.shields.io/badge/Version-0.5.39-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.5.39](https://img.shields.io/badge/AppVersion-0.5.39-informational?style=flat-square)
...
| cdn.tag | string | `"v2.0.2-rc.5"` | Image tag |
...
| dfdaemon.tag | string | `"v2.0.2-rc.5"` | Image tag |
...
| manager.tag | string | `"v2.0.2-rc.5"` | Image tag |
...
| scheduler.tag | string | `"v2.0.2-rc.5"` | Image tag |
