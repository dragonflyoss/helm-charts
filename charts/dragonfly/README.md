...
| dfdaemon.tag | string | `"v2.0.3-beta.8"` | Image tag |
...
| manager.tag | string | `"v2.0.3-beta.8"` | Image tag |
...
| scheduler.tag | string | `"v2.0.3-beta.8"` | Image tag |
...
| seedPeer.tag | string | `"v2.0.3-beta.8"` | Image tag |
