...
| dfdaemon.tag | string | `"v2.1.0-alpha.6"` | Image tag |
...
| inference.enable | bool | `false` | Enable inference |
| inference.fullnameOverride | string | `""` | Override inference fullname |
| inference.grpcPort | int | `8001` | GRPC service port |
| inference.image | string | `"nvcr.io/nvidia/tritonserver"` | Image repository |
| inference.modelRepositoryPath | string | `nil` |  |
| inference.name | string | `"inference"` | inference name |
| inference.nameOverride | string | `""` | Override inference name |
| inference.pullPolicy | string | `"IfNotPresent"` | Image pull policy |
| inference.replicas | int | `1` | Number of Pods to launch |
| inference.restPort | int | `8000` | REST service port |
| inference.secret.id | string | `"SECRET_KEY_ID"` |  |
...
| manager.tag | string | `"v2.1.0-alpha.6"` | Image tag |
...
| scheduler.tag | string | `"v2.1.0-alpha.6"` | Image tag |
...
| trainer.config.server.advertisePort | int | `8002` | Advertise port |
