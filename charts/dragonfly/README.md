...
| dfdaemon.tag | string | `"v2.1.31"` | Image tag. |
...
| manager.tag | string | `"v2.1.31"` | Image tag. |
...
| scheduler.tag | string | `"v2.1.31"` | Image tag. |
...
| seedPeer.tag | string | `"v2.1.31"` | Image tag. |
...
| trainer.tag | string | `"v2.1.31"` | Image tag. |
