...
| client.dfinit.image.tag | string | `"v1.3.0"` | Image tag. |
...
| client.image.tag | string | `"v1.3.0"` | Image tag. |
...
| injector.initContainerImage | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"docker.io","repository":"dragonflyoss/client","tag":"v1.3.0"}` | initContainerImage is the image configuration for the init container that will be injected into target pods. |
...
| injector.initContainerImage.tag | string | `"v1.3.0"` | Image tag. Should align with the version of Dragonfly client and seed client. |
...
| seedClient.image.tag | string | `"v1.3.0"` | Image tag. |
