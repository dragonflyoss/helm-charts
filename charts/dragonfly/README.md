...
| dfdaemon.tag | string | `"v2.0.3-beta.9"` | Image tag |
...
| manager.tag | string | `"v2.0.3-beta.9"` | Image tag |
...
| scheduler.tag | string | `"v2.0.3-beta.9"` | Image tag |
...
| seedPeer.tag | string | `"v2.0.3-beta.9"` | Image tag |
