...
| client.dfinit.image.tag | string | `"v1.0.18"` | Image tag. |
...
| client.image.tag | string | `"v1.0.18"` | Image tag. |
...
| manager.image.tag | string | `"v2.3.1"` | Image tag. |
...
| scheduler.image.tag | string | `"v2.3.1"` | Image tag. |
...
| seedClient.image.tag | string | `"v1.0.18"` | Image tag. |
