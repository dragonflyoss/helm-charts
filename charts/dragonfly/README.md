...
| dfdaemon.tag | string | `"v2.0.9-beta.0"` | Image tag |
...
| manager.tag | string | `"v2.0.9-beta.0"` | Image tag |
...
| scheduler.tag | string | `"v2.0.9-beta.0"` | Image tag |
...
| seedPeer.tag | string | `"v2.0.9-beta.0"` | Image tag |
