...
| client.dfinit.image.tag | string | `"v0.2.0"` | Image tag. |
...
| client.image.tag | string | `"v0.2.0"` | Image tag. |
...
| manager.image.tag | string | `"v2.2.0"` | Image tag. |
...
| scheduler.image.tag | string | `"v2.2.0"` | Image tag. |
...
| seedClient.image.tag | string | `"v0.2.0"` | Image tag. |
