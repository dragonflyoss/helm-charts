...
| client.dfinit.image.tag | string | `"v0.1.95"` | Image tag. |
...
| client.image.tag | string | `"v0.1.95"` | Image tag. |
...
| manager.image.tag | string | `"v2.1.53"` | Image tag. |
...
| scheduler.image.tag | string | `"v2.1.53"` | Image tag. |
...
| seedClient.image.tag | string | `"v0.1.95"` | Image tag. |
