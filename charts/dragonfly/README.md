...
![Version: 0.5.15](https://img.shields.io/badge/Version-0.5.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.5.15](https://img.shields.io/badge/AppVersion-0.5.15-informational?style=flat-square)
...
| dfdaemon.extraVolumeMounts | list | `[{"mountPath":"/var/log/dragonfly/dfdaemon","name":"logs"}]` | Extra volumeMounts for dfdaemon. |
