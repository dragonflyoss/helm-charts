...
| client.dfinit.autoRestartContainerRuntime | bool | `true` | autoRestartContainerRuntime indicates whether to restart container runtime when dfinit is enabled. |
...
| client.image.tag | string | `"v0.2.24"` | Image tag. |
...
| seedClient.image.tag | string | `"v0.2.24"` | Image tag. |
