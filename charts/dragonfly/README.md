...
| client.dfinit.image.tag | string | `"v1.2.11"` | Image tag. |
...
| client.image.tag | string | `"v1.2.11"` | Image tag. |
...
| manager.image.tag | string | `"v2.4.2"` | Image tag. |
...
| scheduler.image.tag | string | `"v2.4.2"` | Image tag. |
...
| seedClient.image.tag | string | `"v1.2.11"` | Image tag. |
